    ...
    <div className="App flex flex-col justify-evenly h-screen w-full bg-gradient-to-r from-sky-400 to-blue-500 drop-shadow-lg">
      ...
      <div className='flex flex-col justify-center align-middle h-[80%] w-full text-center drop-shadow-lg'>
        {loaded ? (
          ...
          <form className='flex flex-col w-[90%] mx-auto justify-center h-1/4 bg-white rounded-3xl' onSubmit={handleSubmit}>
            <textarea value={txt} onChange={(e)=>setTxt(e.target.value)} className='w-full h-full rounded-3xl text-[1rem] overflow-auto text-ellipsis' placeholder='Enter the URL of the web article or content of web article...' style={{resize:"none", outline:"none", padding:"10px"}}></textarea>
        ...
        {loaded?(
          <div className='flex flex-col bg-white rounded-3xl mx-auto h-auto w-[85%] max-h-[100%] items-center drop-shadow-lg overflow-auto'>
            <p className='p-2 text-lg text-center overflow-scroll'>{summary}</p>
