...
function App() {
  ...
  return (
    ...
    <div className="App flex-row justify-center h-screen w-full bg-gradient-to-r from-sky-400 to-blue-500 drop-shadow-lg">
      <div className='SummaryBox h-full flex justify-center'>
        <div className='flex-col justify-center content-end h-1/3 w-[85%] mt-4 bg-white rounded-3xl text-center items-center drop-shadow-lg'>
          <form className='flex flex-col justify-center w-full h-full' onSubmit={handleSubmit}>
            <textarea value={txt} onChange={(e)=>setTxt(e.target.value)} className='w-full h-full rounded-3xl overflow-auto' placeholder='Enter the URL of the web article you want to summarize...' style={{resize:"none", outline:"none", padding:"10px"}}></textarea>
            <div className='flex justify-center w-full'>
              <button className='bg-gradient-to-r from-sky-400 to-blue-500 mt-2 mb-1 w-40 h-12 rounded-2xl text-center items-center border-blue-500 border-4 hover:border-sky-400 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 drop-shadow-lg' type='submit'>
                Submit
              </button>
            </div>
          </form>
          {isLoading ? (
            <div className='flex justify-center mt-5 w-full scale-150'>
            ...
            <div className='flex-col justify-center mt-5 h-full w-full bg-white rounded-3xl text-center items-center drop-shadow-lg'>
