...
function App() {
  ...
  return (
    ...
    <div className="App flex-row justify-center h-screen w-full bg-gradient-to-r from-sky-400 to-blue-500 drop-shadow-lg">
      <button className='bg-gradient-to-r from-sky-400 to-blue-500 mt-2 mb-1 w-40 h-12 rounded-2xl text-center items-center border-blue-500 border-4 hover:border-sky-400 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 drop-shadow-lg' onClick={()=>{timer()}}>
        <p className='font-Sono text-xl text-white font-extrabold'>Summarize</p>
      </button>
      <div className='w-full justify-center text-center mb-1'>
        <p className='font-Sono text-lg text-white font-semibold'>OR</p>
      </div>
      <div className='SummaryBox h-[70%] flex justify-center'>
        <div className='flex-col justify-center h-full w-[85%] bg-white rounded-3xl text-center items-center drop-shadow-lg'>
